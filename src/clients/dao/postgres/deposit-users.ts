...
import { UserDB, DepositValidated } from '../../../models';

class DepositUsersTable extends PostgresDB {
    public async getUserData(data: DepositValidated): Promise<UserDB> {
        try {
            this.client.connect();
